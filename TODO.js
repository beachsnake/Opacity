...
//Googlemaps API request template
{
	/* <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBkVnkDdCXLFa1LVHt6toeEPtpbmJNXuOI&callback=initMap"></script> */
}
